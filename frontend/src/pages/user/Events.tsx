...
function EventCard({ event }: EventCardProps) {
    return (
        <div className="flex-shrink-0 w-80 max-w-[90vw] rounded-2xl shadow-lg overflow-hidden bg-bg-primary border border-border-default hover:shadow-xl transition">
            {event.imageUrl && (
                <div
