...
export const EventsManagement: React.FC = () => {
    ...
    const {register, handleSubmit, reset, formState: {errors}} = useForm<EventFormData>({
        ...
        defaultValues: {title: '', description: '', date: '', imageUrl: ''},
    });
    ...
    const handleCreate = useCallback(() => {
        reset({title: '', description: '', date: '', imageUrl: ''});
    ...
    return (
        <div className="space-y-6">
                            ...
                            <TableBody>
                                {paginatedEvents.map((event) => (
                                    <TableRow key={event.id}>
                                        ...
                                        <TableCell>
                                            <span
                                                className="line-clamp-1 text-text-secondary text-sm">{event.description}</span>
                                        </TableCell>
                                        <TableCell>
            ...
            <Modal isOpen={isModalOpen} onClose={closeFormModal} title={editingEvent ? 'Edit Event' : 'Add Event'}
                   size="md">
