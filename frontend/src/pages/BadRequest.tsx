...
export const BadRequest: React.FC = () => (
    <div className="min-h-screen flex flex-col items-center justify-center bg-bg-primary px-4">
        <ExclamationCircleIcon className="h-24 w-24 text-text-warning mb-4" />
        <h1 className="text-6xl font-bold text-text-primary">400</h1>
        <p className="text-xl text-text-secondary mt-2 text-center">Bad request</p>
